...
@pytest.fixture()
def response_pack_service(container: Container) -> ResponsePackService:
    """The REAL service over the real local adapters, exactly as every surface builds it."""
...
def api_client() -> Iterator[TestClient]:
    ...
    from exam_rfi_orchestrator.api.app import app
