...
_AUDIENCE_ENV = "EXAMRFI_IAP_AUDIENCE"
...
class IapIdentityAdapter:
    ...
    def resolve(self, ctx: RequestContext) -> Principal:
        ...
        # verify_token checks signature, audience and expiry. It does NOT check the issuer, so a
        # token from another Google issuer that somehow satisfied the two above would still be
        # refused here.
